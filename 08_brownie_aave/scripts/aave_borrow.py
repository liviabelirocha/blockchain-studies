...
def main():
    ...
    amount_dai_to_borrow = (
        borrowable_eth * 0.95
    ) / dai_eth_price  # borrowable eth -> borrowable dai * 95%
...
def get_asset_price(price_feed_address):
    dai_eth_price_fee = interface.IAggregatorV3(price_feed_address)
    latest_price = dai_eth_price_fee.latestRoundData()[1]
